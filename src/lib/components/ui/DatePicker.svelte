...
<div class="w-full relative" bind:this={calendarContainer}>
    ...
    <button
        type="button"
        class="relative cursor-pointer w-full text-left"
    ...
    {#if showCalendar && !disabled}
        ...
        <div
            class="absolute z-50 mt-1 p-3 bg-themed border border-themed-light rounded-xl shadow-themed-lg min-w-[280px] animate-slide-down"
            role="dialog"
            aria-label="Choose date"
