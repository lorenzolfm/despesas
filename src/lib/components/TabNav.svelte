        ...
        >
            {#each tabs as tab, i}
                <button
                    ...
                    class="relative flex items-center gap-2 px-4 py-3 text-sm whitespace-nowrap transition-all duration-200 rounded-t-lg scroll-snap-start cursor-pointer {activeTab ===
                    tab.id
